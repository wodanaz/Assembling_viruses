...
echo "trim_galore --fastqc --nextera $i trim " >> $root.trimgalore.sh
done
...
Before combining files into directory, rename then using sufix: EXP5_


```bash
cd trim
for file in *trimmed.fq.gz ; do cp $file EXP5_${file} ; done

```

now, move only relevant MESSI samples back

```bash

for number in {1..15} ; do cp trim/EXP5_S${number}_S${number}_R1_001_trimmed.fq.gz . ; done
...
nano reads2.list
S14_S14_R1_001_trimmed.fq.gz$Plate1_A3_S17_R1_001_trimmed.fq.gz$EXP5_S1_S1_R1_001_trimmed.fq.gz 
S15_S15_R1_001_trimmed.fq.gz$Plate1_C3_S19_R1_001_trimmed.fq.gz$EXP5_S2_S2_R1_001_trimmed.fq.gz 
S16_S16_R1_001_trimmed.fq.gz$Plate1_D3_S20_R1_001_trimmed.fq.gz$EXP5_S3_S3_R1_001_trimmed.fq.gz 
S17_S17_R1_001_trimmed.fq.gz$Plate1_E3_S21_R1_001_trimmed.fq.gz$EXP5_S4_S4_R1_001_trimmed.fq.gz 
S19_S19_R1_001_trimmed.fq.gz$Plate1_G3_S23_R1_001_trimmed.fq.gz$EXP5_S5_S5_R1_001_trimmed.fq.gz 
S20_S20_R1_001_trimmed.fq.gz$Plate1_A6_S41_R1_001_trimmed.fq.gz$EXP5_S6_S6_R1_001_trimmed.fq.gz 
S21_S21_R1_001_trimmed.fq.gz$Plate1_B6_S42_R1_001_trimmed.fq.gz$EXP5_S7_S7_R1_001_trimmed.fq.gz 
S22_S22_R1_001_trimmed.fq.gz$Plate1_A4_S25_R1_001_trimmed.fq.gz$EXP5_S8_S8_R1_001_trimmed.fq.gz 
S23_S23_R1_001_trimmed.fq.gz$Plate1_B4_S26_R1_001_trimmed.fq.gz$EXP5_S9_S9_R1_001_trimmed.fq.gz 
S24_S24_R1_001_trimmed.fq.gz$Plate1_C6_S43_R1_001_trimmed.fq.gz$EXP5_S10_S10_R1_001_trimmed.fq.gz 
S25_S25_R1_001_trimmed.fq.gz$Plate1_D6_S44_R1_001_trimmed.fq.gz$EXP5_S11_S11_R1_001_trimmed.fq.gz 
S26_S26_R1_001_trimmed.fq.gz$Plate1_C4_S27_R1_001_trimmed.fq.gz$EXP5_S12_S12_R1_001_trimmed.fq.gz 
S27_S27_R1_001_trimmed.fq.gz$Plate1_F6_S46_R1_001_trimmed.fq.gz$EXP5_S13_S13_R1_001_trimmed.fq.gz 
S28_S28_R1_001_trimmed.fq.gz$Plate1_H6_S48_R1_001_trimmed.fq.gz$EXP5_S14_S14_R1_001_trimmed.fq.gz
S29_S29_R1_001_trimmed.fq.gz$Plate1_A7_S49_R1_001_trimmed.fq.gz$EXP5_S15_S15_R1_001_trimmed.fq.gz
...
echo "cat $rootA $rootB $rootC > $root2.fq.gz" >> $root.bwa.sh;
